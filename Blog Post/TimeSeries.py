...
aug_twenty_storage = all_years[3]
aug_twenty_protect_s = protect_storages[3]
aug_twenty_elevation = all_elevs[3]
aug_twenty_protect_e = protect_elevs[3]
...
# Elevation related to storage
elev_labels = np.interp(
    ax1.get_yticks(),
    np.sort(aug_twenty_storage),
    np.sort(aug_twenty_elevation)
)
