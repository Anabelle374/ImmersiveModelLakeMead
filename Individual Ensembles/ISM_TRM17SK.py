...
# Read Excel file sheet: ISM_TRM17SK
ensemble = pd.read_excel('/Users/anabelle/Documents/HydrologicScenarios/HydrologyScenarios.xlsx' , sheet_name = 'ISM_TRM17SK') # For Mac
#ensemble = pd.read_excel('C:/Users/A02369941/Downloads/HydrologyScenarios.xlsx', sheet_name = 'ISM_TRM17SK') # For HP
# Display data
#print(ensemble)
