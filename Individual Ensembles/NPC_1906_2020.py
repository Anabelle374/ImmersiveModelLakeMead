print("")
print('Ensemble: NPC_1906_2020\n')
from urllib.request import install_opener
import pandas as pd
import openpyxl
#import numpy as np

ensemble = pd.read_excel('/Users/anabelle/Documents/HydrologicScenarios/HydrologyScenarios.xlsx' , sheet_name = 'NPC_1906_2020') # For Mac
#ensemble = pd.read_excel('C:/Users/A02369941/Downloads/HydrologyScenarios.xlsx', sheet_name = 'NPC_1906_2020') # For HP
# Display data
#print(ensemble)
...
for y in ensemble.columns[1:]: # Iterates through each Trace
    ...
    minPosition = minList.index(minimumSum) # Finds the row position of the minimum summation.
    print('Row Position of Minimum Value of Trace:',minPosition + 1)
