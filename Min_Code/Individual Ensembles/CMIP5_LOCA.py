print("")
print('Ensemble: CMIP5_LOCA\n')
from urllib.request import install_opener
import pandas as pd
import openpyxl
#import numpy as np

ensemble = pd.read_excel('/Users/anabelle/Documents/HydrologicScenarios/HydrologyScenarios.xlsx' , sheet_name = 'CMIP5_LOCA') # For Mac
#ensemble = pd.read_excel('C:/Users/A02369941/Downloads/HydrologyScenarios.xlsx', sheet_name = 'CMIP5_LOCA') # For HP
# Display data
#print(ensemble)
