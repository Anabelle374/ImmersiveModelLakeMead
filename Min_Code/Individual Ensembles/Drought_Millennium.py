print("")
print('Ensemble: Drought_Millennium\n')
from urllib.request import install_opener
import pandas as pd
import openpyxl
#import numpy as np

ensemble = pd.read_excel('/Users/anabelle/Documents/GitHub/ImmersiveModelLakeMead/HydrologyScenarios.xlsx' , sheet_name = 'Drought_Millennium') # For Mac
# Display data
#print(ensemble)
...
for y in ensemble.columns[1:]: # Iterates through each Trace
    ...
    TraceY = ensemble[y] # Simplify to call each Trace easier.
